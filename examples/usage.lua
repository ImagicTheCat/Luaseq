...
function async_add(return_async, a,b)
  setTimeout(math.random(250,500), function()
    return_async(a+b)
  end)
end

function async_mult(return_async, a, b)
  local res = 0
  for i=1,b do
    res = async(async_add, res, a)
  end
...
async(function()
  ...
  for i=1,10 do
    print(async(async_add, 10, i))
  end

  print("task using tasks, multiplication using async_add")
  print("mult = "..async(async_mult, 5, 10))
...
async(function()
  ...
  print("mult = "..async(async_mult, 6, 10))
...
async(function()
  ...
  print("mult = "..async(async_mult, 7, 10))
